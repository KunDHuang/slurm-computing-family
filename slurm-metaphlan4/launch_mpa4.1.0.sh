...
/vol/projects/khuang/anaconda3/envs/metaphlan-4.1.0/bin/metaphlan \
    --nproc ${NCPU} \
    --input_type fastq \
    --index ${MDB_VERSION} \
    --force \
    -t rel_ab_w_read_stats \
    --bowtie2db /vol/projects/khuang/databases/metaphlan4 \
    ...
    --profile_vsc \
    --vsc_out ${OPT_DIR_SAMPLE}/${CHILD_INPUT}_vsc.txt

sleep 10
rm ${OPT_DIR_SAMPLE}/stdin_map.bowtie2out.txt
